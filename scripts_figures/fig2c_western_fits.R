...
# upload normalized Western blot ratios and Hill fit parameters for Western blots
western = read.csv("data/westerns.csv")
westernFits = read.csv("data/westerns_fitParam.csv")

# create lables for plotting
...
# use ggplot nls fit with same parameters we got Western blot fits in the first place
