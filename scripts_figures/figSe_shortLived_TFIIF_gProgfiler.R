...
ggsave("figures/panels/fig5/compare_shortTFIIF_gProfiler_and_myEnrichmnet.pdf", width = 5, height = 5, units = "cm")


# uploadresults from g:Profiler
...
ggsave("figures/panels/figSe/TFIIF_shortLived_gProfiler.pdf", width = 9, height = 7, units = "cm")
