...
p + geom_point(alpha = 0.2, color = "grey40") +
  ...
  xlim(-10, 10) +
  ylim(-10, 10)
ggsave("figures/panels/figSd/compare_allPCs_withoutFastSites.pdf", width = 14, height = 14, units = "cm")
...
p + geom_point(alpha = 0.2, color = "grey70") +
  ...
  xlim(-10, 10) +
  ylim(-10, 10)
ggsave("figures/panels/figSd/compare_allPCs_synthesisRate_withoutFastSites.pdf", width = 14, height = 14, units = "cm")
